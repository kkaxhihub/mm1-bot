...
VOUCH_LOG_CHANNEL_ID = 1456558930489639013  # <-- Replace with your channel ID
...
async def vouch(interaction: discord.Interaction, user: discord.Member, reason: str):
    ...
    class VouchButton(discord.ui.View):
        ...
        async def info(self, interaction2: discord.Interaction, button: discord.ui.Button):
            ...
            details_embed.set_footer(text="Powered by Beanie's Bunker")
...
MIDDLEMAN_ROLE_ID = 1463320834507538506 # replace with your middleman role id
...
async def verify(interaction: discord.Interaction, user: discord.Member):
    ...
    scam_embed.set_footer(text="Powered by Beanie's Bunker")
    ...
    verify_embed.set_footer(text="Powered by Beanie's Bunker")
